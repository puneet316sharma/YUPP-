...
function Upload() {
    ...
    const handleSuggestCaption = async () => {
        ...
        try {
            ...
            const suggestionsRes = await axios.post(`${serverUrl}/api/ai/caption`, { mediaUrl, mediaType }, { withCredentials: true });
            ...
            alert("Failed to suggest caption. Please ensure GEMINI_API_KEY is configured.");
        } finally {
            setAiLoading(false);
        }
    };
