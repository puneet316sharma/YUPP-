...
<p className='cursor-pointer text-gray-800 mt-2'>Already have an account ? <span className='border-b-2 border-b-black pb-[3px] text-black' onClick={()=>navigate("/signin")}>Sign In</span></p>
</div>
